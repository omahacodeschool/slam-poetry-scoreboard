...
class SlamsControllerTest < ActionController::TestCase
  ...
  test "should create slam" do
    assert_difference('Slam.count') do
      post :create, slam: { description: @slam.description, event_date: @slam.event_date, master_id: @slam.master_id, name: @slam.name }
    end
  ...
  test "should update slam" do
    put :update, id: @slam, slam: { description: @slam.description, event_date: @slam.event_date, master_id: @slam.master_id, name: @slam.name }
    assert_redirected_to slam_path(assigns(:slam))
  end
